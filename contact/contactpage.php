...
<html lang="en">
    ...
    <body>
        ...
        <section class="contact obj-width sec-space extra-space">
            ...
            <form id="contact-form" method="POST" action="contact.php"> <!-- Corrected action attribute -->
                ...
                <textarea name="message" id="message" rows="5" required></textarea> <!-- Removed unnecessary type attribute -->
